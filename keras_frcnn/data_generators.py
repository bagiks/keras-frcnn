...
def get_anchor_gt(all_img_data, class_count, C, backend, mode='train'):
    print "start sort image"
    all_img_data = sorted(all_img_data)

    print "Finish sort image"
    sample_selector = SampleSelector(class_count)

    while True:
        # print "start shuffle image"
        if mode == 'train':
            random.shuffle(all_img_data)
        # print "finish shuffle image"
        for img_data in all_img_data:
            # print img_data
            try:
                # print "C.balanced_classes: " + str(C.balanced_classes)
                if C.balanced_classes and sample_selector.skip_sample_for_balanced_class(img_data):
                    continue

                # read in image, and optionally add augmentation
                # print "Start read in image, and optionally add augmentation"
                if mode == 'train':
                ...
                # print "Finish read in image, and optionally add augmentation"
